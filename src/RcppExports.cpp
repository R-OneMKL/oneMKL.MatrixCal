...
RcppExport SEXP _oneMKL_MatrixCal_mkl_real_solve(SEXP aSEXP, SEXP bSEXP, SEXP tolSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _oneMKL_MatrixCal_mkl_cmpl_solve(SEXP aSEXP, SEXP bSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_oneMKL_MatrixCal_mkl_real_solve", (DL_FUNC) &_oneMKL_MatrixCal_mkl_real_solve, 3},
    {"_oneMKL_MatrixCal_mkl_cmpl_solve", (DL_FUNC) &_oneMKL_MatrixCal_mkl_cmpl_solve, 2},
